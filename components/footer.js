            ...
            <>
                ...
                <footer className={styles.footer}>
                    <div className={styles.footerLinks}>
                        ...
                        <div><Link href="/downloads"><a className={styles.link}>Database Downloads</a></Link></div>
                    </div>
                    <div>
                    ...
                    <div>
                        <a href="https://youtu.be/_XM9NS4G1-4" target="_blank" rel="noopener noreferrer"><Image style={{borderRadius: '5px'}} src="/images/videoThumbnail.png" alt="Video Thumbnail" width={137} height={80} /></a>
                    </div>
