...
export default function TabsViewer(props) {
    ...
    if ('GTEx_transcriptomics' in sorted_data) {
        gtex_transcriptomics = sorted_data.GTEx_transcriptomics;
    }
    if ('ARCHS4' in sorted_data) {
        archs4 = sorted_data.ARCHS4;
    } 
    if ('Tabula_Sapiens' in sorted_data) {
        tabula_sapiens = sorted_data.Tabula_Sapiens;
    } 
    if ('HPM' in sorted_data) {
        hpm = props.sorted_data.HPM;
    } 
    if ('HPA' in sorted_data) {
        hpa = props.sorted_data.HPA;
    } 
    if ('GTEx_proteomics' in sorted_data) {
        gtex_proteomics = props.sorted_data.GTEx_proteomics;
    }
    if ('CCLE_transcriptomics' in sorted_data) {
        ccle_transcriptomics = props.sorted_data.CCLE_transcriptomics;
    }
    if ('CCLE_proteomics' in sorted_data) {
        ccle_proteomics = sorted_data.CCLE_proteomics;
    }
            ...
            <TabPanel value={database} index={0}>
                {
                    archs4 != null
                        ?
                        <>
                            <h1 style={{ textAlign: 'center' }}>{gene}</h1>
                            <GeneAndGraphDescription NCBI_data={NCBI_data} gene={gene} database={ARCHS4_link} database_desc={ARCHS4_desc_d} data={archs4}/>
            ...
            <TabPanel value={database} index={2}>
                {
                    tabula_sapiens != null
                        ...
                        <>
                            <h1 style={{ textAlign: 'center' }}>{props.gene}</h1>
                            <GeneAndGraphDescription NCBI_data={NCBI_data} gene={props.gene} database={Tabula_Sapiens_link} database_desc={Tabula_Sapiens_desc_d} data={tabula_sapiens}/>
                            <div style={{ height: '13000px' }}>
                                <Plot
                                    data={[tabula_sapiens]}
                                    layout={{
            ...
            <TabPanel value={database} index={3}>
                {
                    ccle_transcriptomics != null
                        ...
                        <>
                            <h1 style={{ textAlign: 'center' }}>{props.gene}</h1>
                            <GeneAndGraphDescription NCBI_data={NCBI_data} gene={props.gene} database={CCLE_transcriptomics_link} database_desc={CCLE_transcriptomics_desc_d} data={ccle_transcriptomics}/>
                            <div style={{ height: '50000px' }}>
                                <Plot
                                    ...
                                    layout={{
                                        ...
                                        yaxis: {
                                            automargin: true,
                                            range: [-0.5, Object.keys(ccle_transcriptomics.y).length]
                                        },
                                        xaxis: {
                                            title: {
                                                text: 'TPM',
            ...
            <TabPanel value={database} index={4}>
                {
                    hpm != null
                        ...
                        <>
                            <h1 style={{ textAlign: 'center' }}>{props.gene}</h1>
                            <GeneAndGraphDescription NCBI_data={NCBI_data} gene={props.gene} database={HPM_link} database_desc={HPM_desc_d} data={hpm}/>
            ...
            <TabPanel value={database} index={5}>
                {
                    hpa != null
                        ...
                        <>
                            <h1 style={{ textAlign: 'center' }}>{props.gene}</h1>
                            <GeneAndGraphDescription NCBI_data={NCBI_data} gene={props.gene} database={HPA_link} database_desc={HPA_desc_d} data={hpa}/>
                            <div style={{ height: '4500px' }}>
                                <Plot
                                    ...
                                    layout={{
                                        ...
                                        yaxis: {
                                            automargin: true,
                                            range: [-0.5, Object.keys(hpa.y).length]
                                        },
                                        xaxis: {
                                            "categoryorder": "array",
            ...
            <TabPanel value={database} index={6}>
                {
                    gtex_proteomics != null
                        ...
                        <>
                            <h1 style={{ textAlign: 'center' }}>{props.gene}</h1>
                            <GeneAndGraphDescription NCBI_data={NCBI_data} gene={props.gene} database={GTEx_proteomics_link} database_desc={GTEx_proteomics_desc_d} data={gtex_proteomics}/>
                            <div style={{ height: (Object.keys(gtex_proteomics.y).length * 50).toString() + 'px' }}>
                                <Plot
            ...
            <TabPanel value={database} index={7}>
                {
                    ccle_proteomics != null
                        ...
                        <>
                            <h1 style={{ textAlign: 'center' }}>{props.gene}</h1>
                            <GeneAndGraphDescription NCBI_data={NCBI_data} gene={props.gene} database={CCLE_proteomics_link} database_desc={CCLE_proteomics_desc_d} data={ccle_proteomics}/>
                            <div style={{ height: (Object.keys(ccle_proteomics.y).length * 25).toString() + 'px' }}>
                                <Plot
                                    ...
                                    layout={{
                                        ...
                                        yaxis: {
                                            automargin: true,
                                            range: [-0.5, Object.keys(ccle_proteomics.y).length]
                                        },
                                        xaxis: {
                                            title: {
