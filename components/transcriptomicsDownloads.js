...
export default function TranscriptomicsDownloads() {
    ...
    const rowsTranscript = React.useMemo(() => [
        createData(<img className={styles.databaseLogo} src={runtimeConfig.NEXT_PUBLIC_ENTRYPOINT + "/images/archs4.png"} alt="ARCHS4 Logo"/>, '495.3 MB', '1425088 x 253', 'tsv', 'gzip', <a href={runtimeConfig.NEXT_PUBLIC_DOWNLOADS + 'ARCHS4.tsv.gz'} download="ARCHS4_transcript.tsv.gz"><IconButton><FileDownloadIcon/></IconButton></a>),
