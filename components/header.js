                ...
                <div className={styles.longTitle}>
                    ...
                    <div className={styles.rightDiv}>
                        <div className={styles.verticalFlexbox}>
                            ...
                            <Link href={runtimeConfig.NEXT_PUBLIC_TARGETRANGERURL} ><a style={{textDecoration: 'none'}}><img src={runtimeConfig.NEXT_PUBLIC_ENTRYPOINT + '/images/TargetRangerLogo.png'} alt="Logo" width={50} /><div className={styles.sisterSite}><b>TargetRanger</b></div></a></Link>
                        </div>
